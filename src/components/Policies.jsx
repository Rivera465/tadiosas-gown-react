  ...
  return (
    <section className="policies" id="policies">
      <div style={{ textAlign: 'center', maxWidth: 560, margin: '0 auto 3.5rem' }}>
        <div className="section-label" style={{ justifyContent: 'center' }}>Terms & Conditions</div>
      ...
      <div className="policies-grid">
        ...
        <div className="policy-card">
          ...
          <ol className="policy-list">
            <li>
              The balance must be fully paid upon pick-up of the item.
            </li>
            <li>
            ...
            <li>
              <strong>Strictly no alteration.</strong>
            </li>
            <li>
              There is a <strong>₱150 charge</strong> for broken or changed hangers.
            </li>
          </ol>
        </div>
        ...
        <div className="policy-card">
          ...
          <ol className="policy-list">
            <li>
              Rescheduling is free, but depends on the gown's availability on the rescheduling date.
            </li>
            <li>
